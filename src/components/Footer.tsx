    ...
    <footer className="bg-gray-900 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-theme-blue to-theme-purple bg-clip-text text-transparent">DigitalSync</h3>
            <p className="text-gray-400 mb-4">
              Transforming businesses through innovative digital solutions and technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#realestate" className="text-gray-400 hover:text-white transition-colors">Real Estate Solutions</a></li>
              <li><a href="#retail" className="text-gray-400 hover:text-white transition-colors">Retail Technology</a></li>
              <li><a href="#fintech" className="text-gray-400 hover:text-white transition-colors">Fintech Integration</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400">
              <strong className="text-white">Email:</strong> info@digitalsync.com<br />
              <strong className="text-white">Phone:</strong> +1 (555) 123-4567
            </p>
          </div>
        </div>
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} DigitalSync. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
